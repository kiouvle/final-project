...
export default class SearchInput extends BaseComponent { //класс поисковой формы
  constructor(container, searchCallback) { 
    ...
    this._input = this.findElement('.search-input__text');    
    this._searchButton  = this.findElement('.search-input__button');
    this._searchForm = this.findElement('.search-input__bar');
